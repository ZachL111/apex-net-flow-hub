"""Regression checks for the apex-net-flow-hub casebook."""
...
from casebook.harness import assert_expected, apex_net_flow_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(apex_net_flow_hub_summary(), assert_expected())
